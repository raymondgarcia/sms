...
public class KeycloakService {
    ...
    public AppUser saveUser(AppUser user) {
        ...
        employee.setFirstName(user.getName());
    ...
    public Object login(AppUser employeeVo) {
        ...
        AccessTokenResponse response = authzClient.obtainAccessToken(employeeVo.getUsername(), employeeVo.getPassword());
        return response;
    }
}
